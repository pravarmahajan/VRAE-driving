...
THEANO_FLAGS="floatX=float32" python run.py --num_drivers 50 --num_trajs 200  --rnn_size 64 --latent_size 64 --batch_size 8 --scale 10 --num_epochs 10 --lamda1 0.5  --suffix _Hd
